...
export default function ProfilePage() {
    ...
    const infoRows = [
        { label: t("fullName"), value: name || "—", icon: BsPerson },
        { label: t("emailAddress"), value: email || "—", icon: BsEnvelope },
        { label: t("joined"), value: formatDate(createdAt), icon: BsCalendar3 },
        { label: t("lastUpdated"), value: formatDate(updatedAt), icon: BsClock },
    ];
